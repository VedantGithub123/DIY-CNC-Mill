...
backgroundImg = pygame.image.load("images/CNC Software.png")
startHover = pygame.transform.scale(pygame.image.load("images/startHover.png"), (263, 105))
simulateHover = pygame.transform.scale(pygame.image.load("images/simulateHover.png"), (287, 105))
openHover = pygame.transform.scale(pygame.image.load("images/openHover.png"), (80, 50))
controlHover = pygame.transform.scale(pygame.image.load("images/controlHover.png"), (50, 50))
stepHover = pygame.transform.scale(pygame.image.load("images/stepHover.png"), (80, 38))
stopHover = pygame.transform.scale(pygame.image.load("images/stopHover.png"), (115, 115))
connectHover = pygame.transform.scale(pygame.image.load("images/connectHover.png"), (225, 105))
    ...
    for event in events:
        ...
        if event.type == pygame.MOUSEBUTTONUP:
            ...
            if pygame.Rect(1070, 53, 80, 50).collidepoint(pygame.mouse.get_pos()) and not cncRunning:
                ...
                displayPoints = set()
                try:
                    with open(textbox.getText()) as f:
